...
public class Splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attempt_Update_Check(Application_Specification.APPLICATION_NAME,this, API.get_Android_API(API.select_Configuration),Update_Task, Server_Endpiont.UPDATE_URL,Registers.class);
    }
}
